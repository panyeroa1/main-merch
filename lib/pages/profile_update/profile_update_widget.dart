...
class _ProfileUpdateWidgetState extends State<ProfileUpdateWidget> {
  ...
  void initState() {
    ...
    _model.professionFocusNode!.addListener(() => safeSetState(() {}));
    _model.descbeTextController ??= TextEditingController();
    _model.descbeFocusNode ??= FocusNode();
    _model.descbeFocusNode!.addListener(() => safeSetState(() {}));
  }
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor: (_model.professionFocusNode
                                                    ?.hasFocus ??
                                                false)
                                            ? FlutterFlowTheme.of(context)
                                                .accent1
                                      ...
                                      validator: _model
                                          ...
                                          .asValidator(context),
                                      inputFormatters: [_model.professionMask],
                                    ),
                                    Divider(
                                      height: 2.0,
                                      thickness: 2.0,
                                    ...
                                    TextFormField(
                                      controller: _model.descbeTextController,
                                      focusNode: _model.descbeFocusNode,
                                      autofocus: true,
                                      textCapitalization:
                                          TextCapitalization.words,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        ...
                                        filled: true,
                                        fillColor:
                                            (_model.descbeFocusNode?.hasFocus ??
                                                    false)
                                                ? FlutterFlowTheme.of(context)
                                                    .accent1
                                                : FlutterFlowTheme.of(context)
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await currentUserReference!
                          ...
                          shortDescription: valueOrDefault<String>(
                            _model.descbeTextController.text,
                            'Job Description',
                          ),
                          job: _model.professionTextController.text,
                        ));
