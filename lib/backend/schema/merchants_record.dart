...
class MerchantsRecord extends FirestoreRecord {
  ...
  // "category_list" field.
  DocumentReference? _categoryList;
  DocumentReference? get categoryList => _categoryList;
  ...
  void _initializeFields() {
    ...
    _categoryList = snapshotData['category_list'] as DocumentReference?;
  }
      ...
      MerchantsRecord.getDocumentFromData(
        {
          ...
          'category_list': convertAlgoliaParam(
            snapshot.data['category_list'],
...
Map<String, dynamic> createMerchantsRecordData({
  ...
  String? merchant,
  String? seo,
  DocumentReference? categoryList,
}) {
...
class MerchantsRecordDocumentEquality implements Equality<MerchantsRecord> {
  ...
  bool equals(MerchantsRecord? e1, MerchantsRecord? e2) {
    return e1?.companyName == e2?.companyName &&
        ...
        e1?.seo == e2?.seo &&
        e1?.categoryList == e2?.categoryList;
  }
